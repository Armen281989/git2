# arshak = input('greq cer anun@ ')
# tariq = int(input('greq cer tariq@ '))
# if arshak == 'arshak' and tariq == 25:
# 	print('menq cez enq pntrum')
# else:
# 	print('duq cheq hamapatasxanum mer pahangnerin') 

# import random
# anun = input('inch e cer anun@? ')
# user_rand = int(input('greq 1-10 tiv '))
# comp_rand = random.randint(1,10)
# print(comp_rand)
# if comp_rand == user_rand:
# 	print(user_rand, '=', comp_rand,'havasar, voch voq chhaxtec')
# elif comp_rand > user_rand:
# 	print(anun, comp_rand,'>', user_rand, " duq partveciq")
# else:
